...
var antiDegradeStrategyProfiles = []AntiDegradeStrategyProfile{
	...
	{ID: AntiDegradeModeLegacy, Name: "初代兼容", Description: "复用 sub2 初代的设备与会话身份和 Node.js 24 传输。", Category: "常用", IdentityMode: "session", TLSProfile: "nodejs24", MaxConcurrency: 16, Risk: "中", ApplySupported: true},
