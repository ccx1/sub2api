...
// 出口策略独立于身份保护，启用或还原保护不能覆盖管理员的代理选择。
var mode1ManagedExtraKeys = []string{AntiDegradeMarkerExtraKey, "codex_fingerprint_mode", "enable_tls_fingerprint", "tls_fingerprint_builtin", "tls_fingerprint_profile_id"}
