...
func (r *usageBatchLogRepoStub) GetAccountUsageTrendWithFilters(context.Context, time.Time, time.Time, string, int64, int64, int64, int64, string, string, string, *int16, *bool, *int8, int) ([]usagestats.AccountUsageTrendPoint, error) {
	return nil, nil
}
