...
func init() {
	...
	groupDescIsSharedPool := groupFields[8].Descriptor()
	...
	groupDescSecurityPolicyEnabled := groupFields[9].Descriptor()
	...
	groupDescSecurityPolicyMode := groupFields[10].Descriptor()
	...
	groupDescSecurityPolicyEmailEnabled := groupFields[11].Descriptor()
	...
	groupDescStreamOnly := groupFields[45].Descriptor()
