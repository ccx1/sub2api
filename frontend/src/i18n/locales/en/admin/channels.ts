export default {
    ...
    riskControl: {
      ...
      secpol: {
        open: 'Security Keywords',
        title: 'Group Security Policy Keywords',
        description: 'Custom keywords merge with the {count} builtin sensitive-topic seeds. Global words apply to every group with the policy enabled; group words apply to that group only. Changes take effect within a minute.',
        scope: 'Scope',
        scopeAll: 'All',
        scopeGlobal: 'Global',
        ...
        category: 'Category',
        cat_crack: 'Cracking',
        cat_reverse: 'Reversing',
        cat_pentest: 'Pentesting',
        cat_privesc: 'Privilege escalation',
        cat_evasion: 'Evasion',
        cat_custom: 'Custom',
        keyword: 'Keyword',
        keywordPlaceholder: 'e.g. 0day 交易 (max 200 chars)',
        add: 'Add',
        enabled: 'Enabled',
        empty: 'No custom keywords yet',
        created: 'Keyword added',
        deleted: 'Keyword deleted',
        loadFailed: 'Failed to load security keywords',
        saveFailed: 'Failed to save security keyword',
      },
    },
