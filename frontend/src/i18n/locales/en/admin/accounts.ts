export default {
    accounts: {
      codexTicketProxy: {
        ...
        randomHint: 'Randomly select an available proxy with lower account usage and reuse it while healthy. This setting is independent of the business outbound proxy.',
      ...
      codexTicketHistory: {
        ...
        success: 'Successful',
        failed: 'Failed',
        retainedHint: 'Counts track harvest attempts since recording began, including business verification. Success requires full verification and saving. Only the latest {limit} completed attempts are retained.',
        ...
        exchangeRetainedHint: 'Redacted request/response details are retained only for the latest {limit} new attempts. Older attempts keep model summaries; past payloads cannot be recovered.',
        ...
        retry: 'Retry',
        retryEligible: 'Re-harvest (expiring / missing)',
        retrying: 'Re-harvesting…',
        retryScheduled: 'Started re-harvest for {count} model(s): {models}',
        retrySkipped: 'No expiring or missing tickets need a retry',
