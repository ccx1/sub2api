export default {
    ...
    dashboard: {
      ...
      accountUsageTrendScope: 'Top 10 accounts by tokens in the selected range; all others combined',
    ...
    groups: {
      ...
      statistics: {
        action: 'Stats',
        title: 'Group Full Statistics',
        titleWithName: '{name} · Full Statistics',
        description: 'Usage is counted by the group attached to each request at the time it was recorded. Actual billed usage, book cost, and upstream account cost are shown separately.',
        from: 'Start time',
        to: 'End time (exclusive)',
        apply: 'Apply / Refresh',
        allHistory: 'All history',
        loading: 'Calculating…',
        failedToLoad: 'Failed to load group statistics',
        invalidTime: '{field} is invalid',
        invalidRange: 'End time must be later than start time',
        actualCost: 'Actual billed usage',
        actualCostNote: 'Wallet deductions and subscription usage from historical usage logs',
        bookCost: 'Book cost',
        bookCostNote: 'Standard price stored on usage records',
        accountCost: 'Upstream account cost (local)',
        accountCostNote: 'Uses each record’s account cost and historical multiplier; not an upstream invoice',
        totalRequests: 'Recorded requests',
        totalTokens: 'Tokens (with cache)',
        averageDuration: 'Average duration',
        totalApiKeys: 'Current API keys',
        activeApiKeys: 'Active unexpired keys',
        totalAccounts: 'Bound accounts',
        balanceCost: 'Balance billed usage',
        subscriptionCost: 'Subscription usage',
        zeroChargeRequests: 'Zero-charge records',
        empty: 'No usage records in the selected range.',
        rangeSelected: 'Using the selected time range',
        rangeAll: 'All historical usage',
