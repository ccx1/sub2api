export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        codexTicketEnabled: "Codex ticket harvesting",
        ...
        codexTicketHarvestProxyDesc:
          "Applies to accounts without a ticket proxy override. Account management can override this rule. Used only for harvesting; business requests keep the account's business proxy. Changes apply to subsequent probes without a restart. Paste a full HTTP or SOCKS5h proxy URL including credentials. Leave blank to preserve the saved address.",
