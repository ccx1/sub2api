export default {
  ...
  auth: {
    ...
    affiliateCodeLabel: 'Affiliate Invite Code',
    affiliateCodePlaceholder: 'Enter affiliate invite code (optional)',
    affiliateCodeValid: 'Affiliate invite code is valid',
    affiliateCodeInvalid: 'Invalid affiliate invite code',
    affiliateCodeNotFound: 'Affiliate invite code not found',
    affiliateCodeDisabled: 'Affiliate invite feature is disabled',
    affiliateCodeValidating: 'Affiliate invite code is being validated, please wait',
    affiliateCodeInvalidCannotRegister:
      'Invalid affiliate invite code. Please check and try again or clear the affiliate invite code field',
