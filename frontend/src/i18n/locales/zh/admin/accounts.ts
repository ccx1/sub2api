export default {
    accounts: {
      codexTicketProxy: {
        ...
        randomHint: '从可用代理中优先随机选择占用较低的一条，健康时持续复用。此设置独立于业务出口代理。',
      ...
      codexTicketHistory: {
        ...
        success: '成功',
        failed: '失败',
        retainedHint: '统计为记录启用后的累计采集轮次（含业务复验）；完整验证并保存成功才计为成功。列表仅保留最近 {limit} 条已结束记录。',
        lastAttempt: '最近一次打票',
        startedAt: '开始时间',
        model: '模型',
        result: '结果',
        reason: '失败原因',
        details: '结果详情',
        exchangeRetainedHint: '仅最近 {limit} 条新记录保留脱敏请求/响应详情；更早的记录保留模型摘要，旧记录无法补回报文。',
        requestedModel: '请求模型',
        harvestModel: '采集实际模型',
        ...
        retry: '重试',
        retryEligible: '重新打票（临期/未命中）',
        retrying: '正在重新打票…',
        retryScheduled: '已发起 {count} 个模型的重新打票：{models}',
        retrySkipped: '当前没有临期或未命中的票据',
