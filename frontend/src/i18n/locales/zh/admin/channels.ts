export default {
    ...
    riskControl: {
      ...
      secpol: {
        open: '安全策略词包',
        title: '分组安全策略词包',
        description: '自定义词与 {count} 条内置敏感话题关键词 合并生效。全局词作用于所有开启策略的分组，分组词仅作用于指定分组。修改后一分钟内生效。',
        scope: '范围',
        scopeAll: '全部',
        scopeGlobal: '全局',
        scopeGroup: '指定分组',
        ...
        cat_custom: '自定义',
        keyword: '关键词',
        keywordPlaceholder: '例如：0day 交易（最多 200 字）',
        add: '添加',
        enabled: '启用',
        empty: '暂无自定义词',
        created: '关键词已添加',
        deleted: '关键词已删除',
        loadFailed: '安全策略词包加载失败',
        saveFailed: '安全策略词保存失败',
      },
    },
