export default {
    ...
    dashboard: {
      ...
      accountUsageTrendScope: '区间 Token 前 10 账号，其余账号合并统计',
      otherAccounts: '其他账号',
    ...
    groups: {
      ...
      statistics: {
        action: '统计',
        title: '分组完整统计',
        titleWithName: '{name} · 完整统计',
        description: '用量按请求发生时的分组归属统计。实际计费用量、账面费用和上游账号成本分别展示，避免混淆用户计费与账号成本。',
        from: '开始时间',
        to: '结束时间（不含）',
        apply: '应用 / 刷新',
        allHistory: '全部历史',
        loading: '正在统计…',
        failedToLoad: '无法获取分组统计',
        invalidTime: '{field}格式无效',
        invalidRange: '结束时间必须晚于开始时间',
        actualCost: '实际计费用量',
        actualCostNote: '余额扣减与订阅消耗，按历史用量记录汇总',
        bookCost: '账面费用',
        bookCostNote: '使用记录中的标准定价费用',
        accountCost: '上游账号成本（本地统计）',
        accountCostNote: '使用每条记录的账号成本及历史倍率，不是上游发票',
        totalRequests: '已记录请求',
        totalTokens: 'Tokens（含缓存）',
        averageDuration: '平均耗时',
        totalApiKeys: '当前密钥',
        activeApiKeys: '启用且未过期密钥',
        totalAccounts: '当前绑定账号',
        balanceCost: '余额计费用量',
        subscriptionCost: '订阅计费用量',
        zeroChargeRequests: '零计费记录',
        empty: '当前范围内没有用量记录。',
        rangeSelected: '已按选定时间范围统计用量',
        rangeAll: '全部历史用量',
