export default {
  ...
  auth: {
    ...
    affiliateCodeValid: 'Affiliate code is valid',
    affiliateCodeInvalid: 'Invalid affiliate code',
    affiliateCodeNotFound: 'Affiliate code not found',
    affiliateCodeDisabled: 'Affiliate program is not enabled',
    affiliateCodeValidating: 'Affiliate code is being validated, please wait',
    affiliateCodeInvalidCannotRegister: 'Invalid affiliate code. Please check and try again or clear the field',
  ...
  admin: {
    ...
    riskControl: {
      ...
      requestRecordsFailed: 'Failed to load request records',
      ...
      requestRecords: 'Daily User Request Records',
      requestRecordsHint: 'Shows input excerpts from manual API Key calls. AI responses and image content are not shown. New requests are recorded only when the request-record switch is enabled.',
      emptyRequestRecords: 'No request records. Confirm requests are hitting the current backend; historical request bodies cannot be backfilled.',
      hiddenImageRequest: 'Image request (image content hidden)',
      extractKeywords: 'Extract Keywords',
      extractingKeywords: 'Extracting',
      keywordExtractionTitle: 'Extract Moderation Keywords',
      keywordExtractionModel: 'Extraction Model',
      keywordExtractionModelHint: 'Uses the system-side model and API Keys from content moderation first. If that model only supports Moderations, replace it here with a text generation model.',
      keywordExtractionSource: 'Request Content',
      keywordExtractionCandidates: 'Candidate Keywords',
      keywordExtractionCandidateHint: 'Extracted keyword candidates will appear here.',
      keywordExtractionCandidateMeta: '{count} candidates extracted with model: {model}',
      keywordExtractionEmpty: 'No keyword candidates',
      keywordExtractionFailed: 'Failed to extract keywords',
      clearExtractedKeywords: 'Clear candidates',
      confirmAddKeywords: 'Add to Keywords',
      keywordExtractionAdded: 'Added {count} keyword(s)',
      keywordExtractionAddFailed: 'Failed to add keywords',
      keywordExtractionAllExists: 'All candidate keywords already exist',
      ...
      requestRecordsEnabled: 'Record Daily User Requests',
      requestRecordsEnabledHint: 'When enabled, manual API Key request input excerpts are saved for this table. Keep it off unless needed to avoid rapid data growth.',
      ...
      keywordBanDurationMinutes: 'Keyword hit ban duration (minutes)',
      keywordBanDurationHint: 'After a keyword hit, this user receives 403 for follow-up requests during this duration. Set 0 to block only the current request.',
      ...
      filters: {
        ...
        requestSearch: 'Search group/account/key/request',
        from: 'From',
        to: 'To',
        allGroups: 'All Groups',
