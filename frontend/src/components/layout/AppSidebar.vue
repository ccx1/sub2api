<template>
  ...
  >
    ...
    <div class="sidebar-header" :class="{ 'sidebar-header-collapsed': sidebarCollapsed }">
      ...
      <router-link
        :to="homePath"
        class="sidebar-logo flex h-9 w-9 items-center justify-center overflow-hidden rounded-xl border border-gray-200/80 bg-white/80 shadow-sm transition-opacity hover:opacity-80 dark:border-dark-700 dark:bg-dark-800/80"
        ...
        <div class="sidebar-section">
          <template v-for="item in adminNavItems" :key="item.path">
            ...
            <template v-if="item.children?.length">
              ...
              <!-- Children -->
              <div v-if="!sidebarCollapsed && isGroupExpanded(item)" class="mb-1 ml-4 border-l border-gray-200/90 pl-2 dark:border-dark-600/80">
                <router-link
    ...
    <!-- Bottom Section -->
    <div class="mt-auto border-t border-gray-100/90 p-3 dark:border-dark-800/90">
      <!-- Theme Toggle -->
      <button
        @click="toggleTheme"
