<template>
  <div v-if="hasActiveSubscriptions" class="relative" ref="containerRef">
    ...
    <button
      @click="toggleTooltip"
      class="flex cursor-pointer items-center gap-2 rounded-full border border-primary-200/70 bg-primary-50/80 px-3 py-1.5 transition-colors hover:bg-primary-100 dark:border-primary-800/60 dark:bg-primary-900/20 dark:hover:bg-primary-900/30"
    ...
    <transition name="dropdown">
      <div
        v-if="tooltipOpen"
        class="absolute right-0 z-50 mt-2 w-[340px] overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-xl dark:border-dark-700 dark:bg-dark-800"
      >
