...
const editableDefaults = { ...props.initialDefaults }
delete editableDefaults.codex_ticket_enabled
const { excel_bps_options: initialExcelBPSOptions, ...initialDefaults } = {
  ...editableDefaults,
