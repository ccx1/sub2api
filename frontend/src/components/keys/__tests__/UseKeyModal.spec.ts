...
describe('UseKeyModal', () => {
  ...
  it('renders OpenAI provider, GPT-5.5 and goals feature in Codex config', () => {
    const wrapper = mount(UseKeyModal, {
      props: {
        show: true,
        apiKey: 'sk-test',
  ...
  it('renders OpenAI provider, GPT-5.5 and goals feature in Codex WebSocket config', async () => {
    const wrapper = mount(UseKeyModal, {
      props: {
        show: true,
        apiKey: 'sk-test',
