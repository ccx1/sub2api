                ...
                <Teleport to="body">
                  ...
                  >
                    <div class="overflow-y-auto p-2" :style="{ maxHeight: `${accountToolsDropdownPosition.maxHeight}px` }">
                      ...
                      <button v-if="authStore.isAdmin" class="account-tools-menu-item" @click="openImportSettings">
        ...
        >
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              ...
              <button @click="openMenu(row, $event)" class="account-action-menu-trigger flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-dark-700 dark:hover:text-white">
