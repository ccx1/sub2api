      ...
      <template v-else-if="stats">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              <div class="rounded-lg bg-accent-100 p-2 dark:bg-accent-900/30">
                <Icon name="server" size="md" class="text-accent-600 dark:text-accent-400" :stroke-width="2" />
              </div>
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              <div class="rounded-lg bg-accent-100 p-2 dark:bg-accent-900/30">
                <Icon name="clock" size="md" class="text-accent-600 dark:text-accent-400" :stroke-width="2" />
              </div>
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
